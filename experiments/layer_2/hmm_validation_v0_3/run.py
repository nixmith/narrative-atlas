# layer2_validate.py
# Layer 2 §4 synthetic-data validation harness, Thread A — v0.3 stage.
# v0.3 carries the v0.1 calibration patch and the v0.2 V_prior sweep harness,
# and adds one further change: a one-Newton-step M-step update for the
# state-invariant covariate slope beta_x in em_one. The sweep itself is
# unchanged from v0.2 — same default cell (beta_sell=0.3, a_chan=0.6), same
# 5 V_prior values (0.01, 0.1, 1.0, 4.0, 64.0), same 60 executives per cohort.
# See README.md for the v0.2 PARTIAL_CONFIRMED hypothesis under test.
