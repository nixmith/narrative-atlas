# layer2_validate.py
# Layer 2 §4 synthetic-data validation harness, Thread A — v0.2 stage.
# This stage runs a V_prior-only sweep at the default cell (beta_sell=0.3,
# a_chan=0.6), holding every other knob at the v0.1 settings. The full
# (beta_sell, a_chan) sweep grid from v0.1 is intentionally not run here;
# see README.md for the structural-identification hypothesis under test.
